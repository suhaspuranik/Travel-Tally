      ...
      <nav className="homeNavbar">
        <div className="mainDiv">
          <div className="navbar-logo">
            <Link to="/">
              <img src="/images/logofn.png  " alt="Travel Logo" />
            </Link>
          </div>

          <ul className={`navbar-links-right ${menuOpen ? "active" : ""}`}>
            <li>
              <button onClick={navigateLogin} className="signin-button">
                <FontAwesomeIcon icon={faSignInAlt} /> Sign In
              </button>
            </li>
            <li>
              <button onClick={navigateSignup} className="signup-button">
      ...
      <div className="bodyDiv">
        ...
        <section className="cta">
          ...
          <p>
            ...
            <br /> Create your free account and unlock the full potential of
            TravelTally:
          </p>
